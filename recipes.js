document.addEventListener('DOMContentLoaded', function () {
    ...
    function openMethod() {
        for (i = 0; i < ingredientsTab.length; i++) {
            ...
            ingredientsButton[i].style.fontWeight = 'normal';
        }
        ...
        for (i = 0; i < methodTab.length; i++) {
            ...
            methodButton[i].style.fontWeight = 'bold';
        }
    ...
    function openIngredients() {
        for (i = 0; i < methodTab.length; i++) {
            ...
            methodButton[i].style.fontWeight = 'normal';
        }
        ...
        for (i = 0; i < methodTab.length; i++) {
            ...
            ingredientsButton[i].style.fontWeight = 'bold';
        }
    }
